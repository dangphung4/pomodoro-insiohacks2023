...
function App() {
  ...
  const theme = createTheme({
    palette: {
      ...
      primary: {
        main: darkMode
          ? themeToRender.dark.primary
          : themeToRender.light.primary,
      },
      secondary: {
        main: darkMode
          ? themeToRender.dark.primary
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty(
      "--theme-primary",
      themeToRender[mode].primary
    );
    document.documentElement.style.setProperty(
      "--theme-secondary",
      themeToRender[mode].secondary
    );
    document.documentElement.style.setProperty(
      "--theme-text",
      themeToRender[mode].text
    );
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty(
      "--theme-primary",
      selectedTheme[mode].primary
    );
    document.documentElement.style.setProperty(
      "--theme-secondary",
      selectedTheme[mode].secondary
    );
    document.documentElement.style.setProperty(
      "--theme-text",
      selectedTheme[mode].text
    );
                    ...
                    <>
                      ...
                      >
                        ...
                        <DialogContent>
                          ...
                          <div style={{ marginBottom: "20px" }}>
                            <TextField
                              ...
                              onChange={(e) =>
                                setTempTimerLength(e.target.value)
                              }
                              style={{
                                marginRight: "10px",
                                color: theme.palette.text.secondary,
                              }} // added color property here
                              InputLabelProps={{
                            ...
                            <TextField
                              ...
                              onChange={(e) =>
                                setTempBreakLength(e.target.value)
                              }
                              style={{
                                marginRight: "10px",
                                color: theme.palette.text.secondary,
                            ...
                            <TextField
                              ...
                              onChange={(e) =>
                                setTempCustomPlaylistURL(e.target.value)
                              }
                              style={{
                                marginTop: "10px",
                                color: theme.palette.text.secondary,
                        ...
                        <DialogActions>
                          ...
                          <Button
                            onClick={() =>
                              handleSaveSettings(timerLength, breakLength)
                            }
                            style={{ color: theme.palette.text.primary }}
                          >
                            SAVE
